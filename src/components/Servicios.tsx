...
const servicios = [
  ...
  },
  {
    ...
    title: 'Limpieza Comercial / Industrial / Obras',
    desc: 'Servicios profesionales de limpieza para comercios, industrias y obras. Lavado y pulido de pisos, tratamientos de superficies, lavado de vidrios, limpieza general y trabajos con hidrolavadora.',
    items: [
      'Lavado de pisos, limpieza, encerado, pulido y abrillantado',
      'Tratamiento de superficies (cemento, cerámicos, porcelanatos, piso flotante, parquet, etc.)',
      'Lavado de vidrios',
      'Limpieza general',
      'Limpieza final de obra',
      'Hidrolavado en paredes, pisos y techos',
    ],
    images: [
